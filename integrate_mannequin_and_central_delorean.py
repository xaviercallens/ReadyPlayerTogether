...
# ==============================================================================
# 1. HIGH QUALITY PLAYABLE RPO MANNEQUIN PLAYER (scenes/player_vr/pc_player.tscn)
# ==============================================================================
PC_PLAYER_TSCN = """
...
albedo_color = Color(0.88, 0.9, 0.95, 1)
metallic = 0.8
roughness = 0.15
emission_enabled = true
emission = Color(0.0, 0.6, 0.9, 1)
...
# ==============================================================================
# 2. DELOREAN TIME MACHINE AT THE CENTER OF THE OASIS HUB (scenes/hub/oasis_hub.tscn)
# ==============================================================================
HUB_HEADER = """
...
print("Playable RPO Mannequin avatar & central DeLorean placed in the OASIS Plaza!")
